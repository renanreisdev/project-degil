    ...
    return (
        <main className="flex flex-col items-center p-10 sm:p-10">
            ...
            <ul className="list-disc mt-10">
                <li className="text-[#03466e] font-semibold leading-relaxed">
                ...
                <li className="text-[#03466e] font-semibold leading-relaxed my-3">
            ...
            <div className="flex justify-center items-center gap-2 text-[#03466e] font-semibold leading-relaxed my-10">
                <p className="indent-10">Para saber mais:</p>
                <Link
                    href='/consultoria'
                    target="_self"
                    className="py-3 px-4 bg-secondary text-center uppercase text-sm font-bold text-white rounded transition-all duration-300 hover:bg-hover"
                >
                    Consultoria
                </Link>
            </div>
